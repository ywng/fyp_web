...
class CORE_Controller {
    ...
    private $white_list_uri = array('statistics/getAllOrdersGPSLocation','passenger/register', 'passenger/login', 'driver/register', 'driver/login', 'admin/login'); // this will indicate the script not to run security check
